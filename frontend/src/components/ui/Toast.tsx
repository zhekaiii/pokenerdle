...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "tw:fixed tw:top-0 tw:z-100 tw:flex tw:max-h-screen tw:w-full tw:flex-col-reverse tw:p-4 tw:sm:bottom-0 tw:sm:right-0 tw:sm:top-auto tw:sm:flex-col tw:md:max-w-[420px]",
      className
    )}
    {...props}
  />
